...
function RouteComponent() {
  ...
  return !ENV.APP.IS_REGISTER_ENABLED ? (
    <div className="container mx-auto min-h-svh flex flex-col items-center justify-center">
      <Card className="max-w-sm p-2 rounded-md">
        <CardHeader>
          <CardTitle>Fitur ini telah dinonaktifkan</CardTitle>
        </CardHeader>
      </Card>
    </div>
  ) : (
