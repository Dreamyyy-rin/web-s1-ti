...
import { ClipboardCopy, Download, Ellipsis, Link2, MoveDiagonal } from 'lucide-react'
...
const ActionItems: Array<{
  ...
  { key: 'onCopyLink', icon: <Link2 className="size-4" />, tooltip: 'Copy image link', isLink: true }
]
